...
export function BikeIcon({ className = 'w-7 h-7' }: SVGIconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      ...
      <path d="M12 6c-2.21 0-4 1.79-4 4v4c0 2.21 1.79 4 4 4s4-1.79 4-4v-4c0-2.21-1.79-4-4-4z" fill="currentColor" />
